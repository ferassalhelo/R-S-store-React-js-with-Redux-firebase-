...
import { deletOrder } from "../../redux/actions/orderAction";
...
function DashBordPage() {
  ...
  return (
    <div className="container m-auto my-5">
      {productsReducer.productProccess ? (
        <div className=" row justify-content-center align-items-center position-fixed top-0 end-0 start-0 bottom-0 bg-opacity-50 bg-secondary">
              ...
              >
                <div className="accordion-body px-0">
                  <p className="my-4 fs-5" style={{ wordBreak: "break-all" }}>
                    Title: <a href={item.userData.urlTitle}>{item.userData.urlTitle}</a>
                  </p>
                  <table className="table align-middle bg-white container">
                    <thead className="bg-light">
                      <tr>
                  ...
                  <button
                    onClick={() => dispatch(deletOrder(item.id))}
